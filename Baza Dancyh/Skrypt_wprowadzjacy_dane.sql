...
INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (1, 'Bezpiecznik 16A', 1, '16A', 'Wielkość - D01', 'Char - gG', NULL, NULL);

INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (2, 'frez 5x5', 9, 'ostrze 5 mm', 'podstawa 5mm', NULL, NULL, NULL);

INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (3, 'frez 8x5', 9, 'ostrze 5 mm', 'podstawa 8mm', NULL, NULL, NULL);

INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (4, 'Eti 12H8', 3, 'NO', '3 Piny', 'Laserowy', NULL, NULL);

INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (5, 'Część A', 4, 'ParA', 'ParB', NULL, NULL, NULL);

INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (6, 'Część B', 8, 'ParA', 'ParB', NULL, NULL, NULL);

INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (7, 'Część C', 8, 'ParA', 'ParB', NULL, NULL, NULL);

INSERT INTO CZESCI (ID, NAZWA, TYPY_CZESCI_ID, PARAMETR_1, PARAMETR_2, PARAMETR_3, ZDJECIE, LINK_PRZYKLAD) VALUES (8, 'Część D', 12, 'ParA', 'ParB', NULL, NULL, NULL);
