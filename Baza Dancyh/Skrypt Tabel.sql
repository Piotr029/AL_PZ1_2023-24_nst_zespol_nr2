...
ALTER TABLE czêsci ADD CONSTRAINT czêsci_pk PRIMARY KEY ( id );
...
CREATE TABLE magazyn (
    ...
    nazwa             CHAR(15 CHAR),
    id_miejsca        NUMBER,
    magazyn_miesca_id NUMBER NOT NULL
);

ALTER TABLE magazyn ADD CONSTRAINT magazyn_pk PRIMARY KEY ( id );


CREATE TABLE magazyn_miesca (
    id                 NUMBER NOT NULL,
    nazwa              CHAR(15 CHAR),
    id_pozycji         NUMBER,
    miejsce_pozycja_id NUMBER NOT NULL
...
ALTER TABLE magazyn_miesca ADD CONSTRAINT magazyn_miesca_pk PRIMARY KEY ( id );
...
ALTER TABLE czesci_maszyny_pt
    ADD CONSTRAINT czesci_maszyny_pt_czêsci_fk FOREIGN KEY ( czêsci_id )
        REFERENCES czêsci ( id );
...
ALTER TABLE czêsci
    ADD CONSTRAINT czêsci_typy_czesci_fk FOREIGN KEY ( typy_czesci_id )
...
ALTER TABLE historia_zmian
    ADD CONSTRAINT historia_zmian_czêsci_fk FOREIGN KEY ( czêsci_id )
        REFERENCES czêsci ( id );
...
ALTER TABLE magazyn
    ADD CONSTRAINT magazyn_magazyn_miesca_fk FOREIGN KEY ( magazyn_miesca_id )
        REFERENCES magazyn_miesca ( id );

 
ALTER TABLE magazyn_miesca
    ADD CONSTRAINT miejsce_pozycja_fk FOREIGN KEY ( miejsce_pozycja_id )
        REFERENCES miejsce_pozycja ( id );
...
ALTER TABLE pozycja_czesci
    ADD CONSTRAINT pozycja_czesci_czêsci_fk FOREIGN KEY ( czêsci_id )
        REFERENCES czêsci ( id );
...
ALTER TABLE zamowienia
    ADD CONSTRAINT zamowienia_czêsci_fk FOREIGN KEY ( czêsci_id )
        REFERENCES czêsci ( id );
